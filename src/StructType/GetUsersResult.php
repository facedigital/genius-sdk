...
/**
 * This class stands for GetUsersResult StructType
 * @subpackage Structs
 */
class GetUsersResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    protected $any = null;
    /**
     * Constructor method for GetUsersResult
     * @uses GetUsersResult::setSchema()
     * @uses GetUsersResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\GetUsersResult
     */
