...
/**
 * This class stands for RunQueryResult StructType
 * @subpackage Structs
 */
class RunQueryResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    protected $any = null;
    /**
     * Constructor method for RunQueryResult
     * @uses RunQueryResult::setSchema()
     * @uses RunQueryResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\RunQueryResult
     */
