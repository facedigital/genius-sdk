...
/**
 * This class stands for CreateRegistration StructType
 * @subpackage Structs
 */
class CreateRegistration extends AbstractStructBase
{
    /**
     * The SectionID
    ...
    /**
     * Constructor method for CreateRegistration
     * @uses CreateRegistration::setSectionID()
     * @uses CreateRegistration::setToken()
     * @uses CreateRegistration::setUsername()
     * @param int $sectionID
     * @param string $token
     ...
     * Set SectionID value
     * @param int $sectionID
     * @return \StructType\CreateRegistration
     */
