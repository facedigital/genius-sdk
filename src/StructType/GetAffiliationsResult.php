...
/**
 * This class stands for GetAffiliationsResult StructType
 * @subpackage Structs
 */
class GetAffiliationsResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    protected $any = null;
    /**
     * Constructor method for GetAffiliationsResult
     * @uses GetAffiliationsResult::setSchema()
     * @uses GetAffiliationsResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\GetAffiliationsResult
     */
