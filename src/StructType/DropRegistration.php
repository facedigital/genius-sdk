...
/**
 * This class stands for DropRegistration StructType
 * @subpackage Structs
 */
class DropRegistration extends AbstractStructBase
{
    /**
     * The SectionID
    ...
    /**
     * Constructor method for DropRegistration
     * @uses DropRegistration::setSectionID()
     * @uses DropRegistration::setToken()
     * @uses DropRegistration::setUsername()
     * @param int $sectionID
     * @param string $token
     ...
     * Set SectionID value
     * @param int $sectionID
     * @return \StructType\DropRegistration
     */
